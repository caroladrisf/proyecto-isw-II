...
<div class="container">
    <div class="card mx-auto " id="custom">
        ...
        @endif
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <form method="GET" action="{{ url('/apartados/clientes') }}">
                        <div class="form-group">
                            ...
                            <div class="list-group mr-5">
                                ...
                                <a href="{{ action('ApartadoController@asignarCliente', $c->id) }}" class="list-group-item list-group-item-action">
                    ...
                    <table class="table table-borderless table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td col-span="2">
                                    <form action="{{ action('ApartadoController@quitarCliente') }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="col-md-6">
                    ...
                    <form method="GET" action="{{ url('/apartados/articulos') }}">
                        <div class="form-group">
                            ...
                            <div class="list-group mr-5">
                                ...
                                <a href="{{ action('ApartadoController@seleccionarArticulo', $art->id) }}" class="list-group-item list-group-item-action">
                    ...
                    @isset($articulo)
                    <form method="POST" action="{{ action('ApartadoController@asignarArticulo', $articulo->id) }}">
                        @csrf
                        <table class="table table-borderless table-sm">
                            <thead>
                                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <form action="{{ action('ApartadoController@quitarArticulo', $articulos[$i]->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="card-footer d-flex justify-content-end align-items-center">
            <form class="w-25 mx-1" method="POST" action="{{ action('ApartadoController@store') }}">
                @csrf
                <button type="submit" class="btn btn-primary btn-block">Aceptar</button>
            </form>
            <form class="w-25 mx-1" method="POST" action="{{ action('ApartadoController@cancelar') }}">
                @csrf
                @method('DELETE')
